...
import { Firestore, collection, getDocs, QuerySnapshot } from '@angular/fire/firestore';
...
export class EmergencyRequestService {
  ...
  async getRequestCount(): Promise<number> {
    try {
      const emergencyrequestRef = collection(this.firestore, this.collectionName); // Get the reference to the collection
